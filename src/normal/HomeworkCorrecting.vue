						...
						<a-affix :offset-top="top">
							<a-collapse v-model="activeKey">
								...
								<a-collapse-panel key="1" header="团队第二次作业github编程实战">
									...
									<a-table :columns="columns" :data-source="data" :scroll={x:1500} bordered
										:pagination="false">
										<span v-for="i in columns" :key="i.dataIndex" :slot="i.dataIndex"
											slot-scope="text" contentEditable=true>
											{{text}}
										</span>
									</a-table>
								</a-collapse-panel>
